...
export default function ConnectionsTab({ onViewHistory }) {
  ...
  const handleIngest = async (id) => {
    ...
    try {
      ...
      setToast({
        type: "success",
        message: "Ingestion triggered — check the Recent Runs / History tabs",
      });
    } catch (err) {
      setToast({ type: "error", message: err.message });
    } finally {
      ...
      {showForm && (
        <div className="card form-card">
          <div className="tabs">
            <button
              type="button"
              className={activeFormTab === "details" ? "tab active" : "tab"}
